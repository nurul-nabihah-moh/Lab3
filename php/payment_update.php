...
$signed= hash_hmac('sha256', $signing, 'S-G8lG4sqnyfEhHlSxexu3RQ');
if ($signed === $data['x_signature']) {
    ...
    if ($paidstatus == "Success"){
       ...
       $conn->query($sqlinsert);
        ...
        echo '<br><br><body><div><h2><br><br><center>Receipt</center></h1><table border=1 width=80% align=center><tr><td>Order id</td><td>'.$orderid.'</td></tr><tr><td>Receipt ID</td><td>'.$receiptid.'</td></tr><tr><td>Email to </td><td>'.$userid. ' </td></tr><td>Amount </td><td>RM '.$amount.'</td></tr><tr><td>Payment Status </td><td>'.$paidstatus.'</td></tr><tr><td>Date </td><td>'.date("d/m/Y").'</td></tr><tr><td>Time </td><td>'.date("h:i a").'</td></tr></table></div></body>';
